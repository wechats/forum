...
<html>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.com.hk/"><img src="http://www.hostinger.com.hk/images/logo-cn.png" alt="虚拟主机" /></a>
                </div>
                <div class="content">
                    <h1>您的账号已成功创建！</h1>
                    <p><b><? print $host; ?></b> 已成功在服务器上创建！请通过FTP或在线文件管理器删除文件public_html目录中的default.php，然后上传您的网站来开始使用您的空间账号。</p>
                    <p>您当前在public_html目录下的文件有：</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.com.hk/web-hosting" target="_blank">虚拟主机</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.com.hk/free-hosting" target="_blank">免费空间</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.com.hk/forum" target="_blank">交流社区</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.com.hk/" target="_blank">登录</a>
                </div>
                <div class="social-icons">
                    <a href="https://www.facebook.com/Hostinger"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
