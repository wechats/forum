...
UE.I18N['zh-tw'] = {
	'labelMap':{
		'anchor':'錨點', 'undo':'復原', 'redo':'重做', 'bold':'粗體', 'indent':'縮排', 'snapscreen':'截圖',
		'italic':'傾斜', 'underline':'底線', 'strikethrough':'刪除線', 'subscript':'下標','fontborder':'字元邊框',
		'superscript':'上標', 'formatmatch':'格式刷', 'source':'原始碼', 'blockquote':'區塊引述',
		'pasteplain':'純文字貼上模式', 'selectall':'全選', 'print':'列印', 'preview':'預覽',
		'horizontal':'分隔線', 'removeformat':'清除格式', 'time':'時間', 'date':'日期',
		'unlink':'取消連結', 'insertrow':'前插入列', 'insertcol':'前插入行', 'mergeright':'右合併儲存格', 'mergedown':'下合併儲存格',
		'deleterow':'刪除列', 'deletecol':'刪除行', 'splittorows':'分割成列',
		'splittocols':'分割成行', 'splittocells':'完全分割儲存格','deletecaption':'刪除表格標題','inserttitle':'插入標題',
		'mergecells':'合併多個儲存格', 'deletetable':'刪除表格', 'cleardoc':'清除文件','insertparagraphbeforetable':"表格前插入段落",'insertcode':'代碼語言',
		'fontfamily':'字型', 'fontsize':'字型大小', 'paragraph':'段落格式', 'simpleupload':'單圖上傳', 'insertimage':'多圖上傳','edittable':'表格屬性','edittd':'儲存表格屬性', 'link':'超連結',
		'emotion':'表情', 'spechars':'特殊字元', 'searchreplace':'尋找取代', 'map':'Baidu 地圖', 'gmap':'Google地圖',
		'insertvideo':'影片', 'help':'說明', 'justifyleft':'靠左對齊', 'justifyright':'靠右對齊', 'justifycenter':'置中對齊',
		'justifyjustify':'左右對齊', 'forecolor':'字型色彩', 'backcolor':'背景色彩', 'insertorderedlist':'排序清單',
		'insertunorderedlist':'未排序清單', 'fullscreen':'全螢幕', 'directionalityltr':'從左向右的輸入順序', 'directionalityrtl':'從右向左的輸入順序',
		...
		'webapp':'網路應用程式','touppercase':'字母大寫', 'tolowercase':'字母小寫','background':'背景','template':'範本','scrawl':'塗鴉',
	...
	'insertimage':{
		'static':{
			...
			'searchType':{'title':"圖片類型", 'options':["新聞", "桌布", "表情", "相片"]}, //select的option
			'searchTxt':{'value':"請輸入搜索關鍵字"},
			'searchBtn':{'value':"立即搜尋"},
			'searchReset':{'value':"清除搜尋"},
			'noneAlign':{'title':'無浮動'},
			'leftAlign':{'title':'左浮動'},
			'rightAlign':{'title':'右浮動'},
			'centerAlign':{'title':'置中獨佔一行'}
		},
